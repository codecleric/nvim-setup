...
bindsym $mod+$i3-wm.binding.terminal exec i3-sensible-terminal
...
set_from_resource $i3-wm.program.look_selector i3-wm.program.look_selector /run/current-system/sw/bin/rofi-theme-selector
bindsym $mod+$i3-wm.binding.look_selector exec $i3-wm.program.look_selector

## Launch // Greenclip clipboard manager <><Shift> v ##
...
## Print Screen
bindsym --release Print exec "scrot -m '/home/brian/Pictures/screenshots/%s_%H%M_%d.%m.%Y_$wx$h.png'"
bindsym --release Shift+Print exec "scrot -s '/home/brian/Pictures/screenshots/%s_%H%M_%d%m%Y_$wx$h.png'"
bindsym --release $mod+Shift+Print exec "scrot -u -d 4 '/home/brian/Pictures/screenshots/%s_%H%M_%d%m%Y_$wx$h.png'"
###############################################################################
...
set_from_resource $i3-wm.program.display i3-wm.program.display xfce4-settings-manager --class=floating_window display
